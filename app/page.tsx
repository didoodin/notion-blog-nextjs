...
const socialLinks = [
  {
    icon: Youtube,
    href: 'https://www.youtube.com/didoodin',
  },
  {
    icon: Github,
    href: 'https://github.com/didoodin',
  },
  {
    icon: BookOpen,
    href: 'https://www.inflearn.com/users/432199/@didoodin',
  },
  {
    icon: Instagram,
    href: 'https://www.instagram.com/didoodin',
  },
];
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold">디두딘</h3>
